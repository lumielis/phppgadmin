...
1. **Login**
    ...
    - Select database (or use default)

2. **Navigate Objects**
    - Use tree navigation on the left to browse:
        - Servers → Databases → Schemas → Objects
    - Click on any object to view details

3. **Execute Queries**
    - Click "SQL" button in toolbar
    - Enter SQL query in editor
    - Click "Execute" to run query
    - Results appear below editor with pagination

4. **Browse Data**
    - Navigate to a table in tree
    - Click "Browse" to view data
    - Use filters, sorting, and pagination
    - Click "Edit" to modify rows

5. **Export Data**
    - Select table or database
    - Click "Export"
...
4. Select owner, encoding, template
5. Click "Create"
...
1. Navigate to database/schema/table
2. Click "Privileges"
3. Select role/user
...
1. Select database in tree
2. Click "Export"
3. Choose "Structure and data"
...
- PHP 7.2+ with PostgreSQL extension
- ADOdb (custom-modified) for database abstraction
- Composer for dependency management
- PSR-4 autoloading

**Database:**

- PostgreSQL 9.0+ with extensive feature support

**Frontend:**

- Vanilla JavaScript (ES5/ES6) - no jQuery
- Frameset-based single-page navigation
...
- greenlion/php-sql-parser for SQL analysis
...
│   └── config-dist.inc.php    # Distribution template
├── libraries/                 # Core PHP libraries
│   ├── bootstrap.php          # Application initialization
│   ├── PhpPgAdmin/            # PSR-4 namespace root
│   │   ├── Core/              # Core classes (AppContainer, AppContext)
│   │   ├── Database/          # Database operations
│   │   │   ├── Actions/       # Database action classes
│   │   │   ├── Dump/          # Export dumpers
│   │   │   └── Export/        # Export formatters
│   │   ├── Gui/               # GUI rendering (TableRenderer, etc.)
│   │   ├── Html/              # HTML element builders
│   │   └── Security/          # Security utilities
│   ├── adodb/                 # ADOdb library
│   └── adodb-custom/          # Custom ADOdb extensions
├── js/                        # JavaScript files
│   ├── core/                  # Core JS (frameset, utilities)
...
│   ├── cappuccino/            # Dark theme
│   └── gotar/                 # Minimalist theme
├── lang/                      # Language translations (30+ languages)
├── plugins/                   # Plugin system
│   ├── GuiControl/            # GUI customization plugin
│   └── Report/                # Reporting plugin
├── docs/                      # Technical documentation
├── tests/                     # Test suites
│   ├── selenium/              # Selenium tests
│   └── simpletests/           # Unit tests
├── temp/                      # Temporary files (exports, imports)
├── sessions/                  # PHP session storage
├── [page].php                 # Page endpoints (tables.php, schemas.php, etc.)
...
Unified export system with streaming support:

- All formatters accept ADORecordSet input
- Streaming output for memory efficiency
- Multiple formats: SQL, COPY, CSV, Tab, HTML, XML, JSON
- See [docs/UNIFIED_EXPORT_ARCHITECTURE.md](docs/UNIFIED_EXPORT_ARCHITECTURE.md)

#### 2. Tree Navigation System

Hierarchical database object navigation:

- ID-based navigation: servers → databases → schemas → objects
- Persistent state across page loads
- Efficient object lookup
- See [docs/TREE_README_SYSTEM.md](docs/TREE_README_SYSTEM.md)

#### 3. Database Actions

Separation of concerns:

- Action classes in `Database/Actions/`
- UI rendering in `Gui/`
...
- POST caching for form state
- History management
- No full page reloads
- Located in `js/core/frameset.js`
...
- **[TREE_README_SYSTEM.md](docs/TREE_README_SYSTEM.md)** - Tree navigation documentation index
- **[TREE_QUICK_GUIDE.md](docs/TREE_QUICK_GUIDE.md)** - Visual quick start guide
- **[TREE_ARCHITECTURE.md](docs/TREE_ARCHITECTURE.md)** - Tree system deep dive
- **[TREE_ID_IMPLEMENTATION.md](docs/TREE_ID_IMPLEMENTATION.md)** - Working with tree IDs
- **[TREE_ID_MIGRATION.md](docs/TREE_ID_MIGRATION.md)** - Migration guide
- **[UNIFIED_EXPORT_ARCHITECTURE.md](docs/UNIFIED_EXPORT_ARCHITECTURE.md)** - Export system architecture
